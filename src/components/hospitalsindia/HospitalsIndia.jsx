...
const HospitalsIndia = () => {
    return (
        <>
            ...
            <div className="container specialities my-5">

                <div className="d-flex flex-row">

                    <div className="row d-flex flex-row justify-content-between">

                        <div className="col-xs-12 col-md-5 left justify-content-center" >
                            <img src="https://cdn.apollohospitals.com/dev-apollohospitals/2020/09/apollo-home-ahmedabad-1.jpg" alt="" style={{ width: "100%", borderRadius: "2rem" }} />
                        </div>
                        <div className="col-xs-12 col-md-6 right d-flex flex-wrap flex-row my-4 " style={{ textAlign: 'initial' }} >
                            <div>
                                <p className='mb-0'>
                                    LOCATION
                                </p>
                                ...
                                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Molestiae itaque minima inventore. Tenetur voluptatibus illum ipsum vero id, eligendi fuga provident pariatur dolores earum inventore nisi est, nam at error officiis. Praesentium, laboriosam tenetur!</p>
                            </div>
