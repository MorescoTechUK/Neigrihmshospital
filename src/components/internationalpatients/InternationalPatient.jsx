...
import './InternationalPatient.css'
                ...
                <div className="container specialities my-5">
                    ...
                    <div className="d-flex flex-row justify-content-center">
                        ...
                        <Slide direction='right' triggerOnce duration="1500">
                            <div className="row d-flex flex-row justify-content-between text-center">
                                ...
                                <div>
                                    ...
                                    <p style={{ opacity: '0.9' }}>“Bringing healthcare of International standards within the reach of every individual.”</p>
                                </div>
                                ...
                                <div className="col-xs-12 col-md-5 left justify-content-center" >
                                    <img src="https://www.apollohospitals.com/wp-content/themes/apollohospitals/assets-v3/images/ips_ah.webp" alt="" style={{ width: "100%", borderRadius: "2rem", border: "0.9rem solid white" }} />
                                </div>
