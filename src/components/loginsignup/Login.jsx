...
const Login = () => {
  ...
  useEffect(() => {
    ...
    if (window.location.href === "http://localhost:5173/Neigrihmshospital/patient" || window.location.href === "http://localhost:5173/Neigrihmshospital/signup") {
        ...
        <div className="container">
          ...
          <div className="row justify-content-center" style={{ height: "100vh", justifyContent: "center" }}>
            <div className="d-flex align-items-center" style={{ width: "85%" }}>
              <div className=" d-md-flex box my-4 p-md-5" style={{ width: "100%" }}>
                  ...
                  <div style={{ width: "100%" }}>
                    ...
                    <form action="#" className="signin-form">
                      ...
                      <div className="form-group">
                        <button onClick={handleSubmit} type="submit" className="form-control btn rounded submit px-3 py-3 my-2" style={{ backgroundColor: "#E3B04B", color: "white" }}>Sign In</button>
                      </div>
                        ...
                        <div className="w-50 text-left">
                          <div className="form-check">
                            ...
                            <label className="form-check-label" htmlFor="flexCheckChecked" style={{ color: "#e3b04b", fontSize: "1.1rem" }} >
                              <input className="form-check-input input1" type="checkbox" value="" id="flexCheckChecked checkbox1" style={{ width: "1.1em", height: "1.1em" }} onChange={handleChange}></input>
                              <span>
                                Remember Me
                              </span>
                            </label>
                    ...
                    <p className="text-center" style={{ opacity: "0.7", fontSize: "1.1rem" }}>Not a member? <Link to="/signup" data-toggle="tab" href="#signup" style={{ color: "#e3b04b" }}>Sign Up</Link></p>
                  </div>
                </div>
              </div>
            </div>
